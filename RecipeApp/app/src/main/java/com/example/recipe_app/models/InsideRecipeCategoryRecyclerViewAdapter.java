...
import com.example.recipe_app.activities.RecipeDetailsActivity;
...
public class InsideRecipeCategoryRecyclerViewAdapter extends RecyclerView.Adapter<InsideRecipeCategoryRecyclerViewAdapter.MyViewHolder> implements Filterable {
    ...
    public InsideRecipeCategoryRecyclerViewAdapter(Context context, List<Recipe> recipeData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //***************Passing data to the RecipeDetailsActivity activity**********
